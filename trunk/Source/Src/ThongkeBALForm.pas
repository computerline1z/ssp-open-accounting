...
uses MainDataMdl, GlobalUnit, PopupForm, dxTreeGridMenus, DocListForm, HtmlHlp;
...
begin
  ...
  {them dong nay sua loi bug thong ke}
  qryTKThuChi.ParamByName('branch_id').Value:=vpBranch_id;
  {end sua loi bug thong ke}
  qryTKThuChi.Open;
