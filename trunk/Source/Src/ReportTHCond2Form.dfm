object ReportTHCond2Frm: TReportTHCond2Frm
  Left = -4
  Top = -4
  HelpContext = 17
  ...
  object qryLCTTCond: TIBOQuery
    ...
    DatabaseName = 
      ...
      '09_2010.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM RPT_REPORT_TH_DK_2'
      'WHERE'
      '   FROMID = :OLD_FROMID AND'
      '   ID = :OLD_ID')
    EditSQL.Strings = (
      'UPDATE RPT_REPORT_TH_DK_2 SET'
      '   FROMID = :FROMID, /*PK*/'
      '   ID = :ID, /*PK*/'
      '   GHICHU = :GHICHU,'
      '   HESO = :HESO'
    ...
    InsertSQL.Strings = (
      'INSERT INTO RPT_REPORT_TH_DK_2('
      '   FROMID, /*PK*/'
      '   ID, /*PK*/'
      '   GHICHU,'
      '   HESO)'
