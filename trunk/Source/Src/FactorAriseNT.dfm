object FactorlAriseNTFrm: TFactorlAriseNTFrm
  Tag = 30
  Left = 284
  Top = 232
  Width = 638
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = 'T'#7893'ng h'#7907'p t'#236'nh h'#236'nh y'#7871'u t'#7889' ph'#225't sinh theo ngo'#7841'i t'#7879
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 136
  ...
  object qryBalArise: TIBOQuery
    ...
    SQL.Strings = (
        ...
        'select cock,codk,cops,loaidt,madt,mant,nock,nodk,nops,shtk,tendt' +
        ',mayt,loaiyt, '
      'shtk||madt||mayt||loaidt||loaiyt||mant  KF'
      'from macro_yeutops_nt(:period_id,:period_id,:branch_id)'
      'order by madt')
    FieldOptions = []
    Left = 297
    Top = 236
