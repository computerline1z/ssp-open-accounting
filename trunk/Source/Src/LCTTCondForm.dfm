object LCTTCondFrm: TLCTTCondFrm
  Left = 386
  Top = 286
  HelpContext = 17
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = #272'i'#7873'u ki'#7879'n B'#225'o c'#225'o l'#432'u  chuy'#7875'n ti'#7873'n t'#7879
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 136
  ...
  object qryLCTTCond: TIBOQuery
    ...
    DeleteSQL.Strings = (
      'DELETE FROM RPT_LCTT_CONDITION'
      'WHERE'
    ...
    InsertSQL.Strings = (
      'INSERT INTO RPT_LCTT_CONDITION('
      '   BRANCH_ID, /*PK*/'
      '   ID, /*PK*/'
      '   TKCOBDV, /*PK*/'
      '   TKNOBDV, /*PK*/'
    ...
    SQL.Strings = (
      ...
      '     , HESO'
      '     , BRANCH_ID '
      'FROM RPT_LCTT_CONDITION where ID=:ID and branch_id = :branch_id')
    FieldOptions = []
    Left = 163
    Top = 64
    ...
    object qryLCTTCondBRANCH_ID: TWideStringField
      FieldName = 'BRANCH_ID'
      Required = True
      Size = 6
    end
