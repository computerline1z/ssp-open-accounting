object FrmDK_THKQHDKD: TFrmDK_THKQHDKD
  Left = 209
  Top = 252
  HelpContext = 17
  ...
  object qryDK_THHDKD: TIBOQuery
    ...
    DatabaseName = 
      ...
      'UNTING.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM RPT_DK_TONGHOP_KQHDKD'
      'WHERE'
      '   ID = :OLD_ID AND'
      '   TKCOBDV = :OLD_TKCOBDV AND'
      '   TKNOBDV = :OLD_TKNOBDV')
    EditSQL.Strings = (
      'UPDATE RPT_DK_TONGHOP_KQHDKD SET'
      '   ID = :ID, /*PK*/'
      '   TKCOBDV = :TKCOBDV, /*PK*/'
      '   TKNOBDV = :TKNOBDV, /*PK*/'
      '   GHICHU = :GHICHU'
    ...
    InsertSQL.Strings = (
      'INSERT INTO RPT_DK_TONGHOP_KQHDKD('
      '   ID, /*PK*/'
      '   TKCOBDV, /*PK*/'
      '   TKNOBDV, /*PK*/'
      '   GHICHU)'
    ...
    BeforeDelete = qryDK_THHDKDBeforeDelete
    AfterInsert = qryDK_THHDKDAfterInsert
    BeforePost = qryDK_THHDKDBeforePost
    OnNewRecord = qryDK_THHDKDNewRecord
    OnPostError = qryDK_THHDKDPostError
    OnDeleteError = qryDK_THHDKDDeleteError
    SQL.Strings = (
      'SELECT ID'
      '     , TKNOBDV'
      '     , TKCOBDV'
      '     , GHICHU'
      'FROM RPT_DK_TONGHOP_KQHDKD'
      'where ID=:ID')
    FieldOptions = []
    Left = 163
    Top = 52
    object qryDK_THHDKDID: TSmallintField
      FieldName = 'ID'
      Required = True
    end
    object qryDK_THHDKDTKNOBDV: TWideStringField
      FieldName = 'TKNOBDV'
      Required = True
      Size = 15
    end
    object qryDK_THHDKDTKCOBDV: TWideStringField
      FieldName = 'TKCOBDV'
      Required = True
      Size = 15
    end
    object qryDK_THHDKDGHICHU: TWideStringField
      FieldName = 'GHICHU'
      Size = 126
    end
  end
  object dsDK_THHDKD: TDataSource
    DataSet = qryDK_THHDKD
    Left = 163
    Top = 83
  end
