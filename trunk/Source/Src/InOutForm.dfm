object InOutFrm: TInOutFrm
  ...
  object dxBarManager1: TdxBarManager
    ...
    object btnRutSodu: TdxBarButton
      Caption = 'R'#250't s'#7889' t'#7891'n cu'#7889'i k'#7923' tr'#432#7899'c'
      Category = 0
      Hint = 'R'#250't s? t?n cu?i k? tru?c'
      Visible = ivAlways
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = 'T'#236'nh h'#236'nh nh'#7853'p xu'#7845't trong k'#7923
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 136
  ...
  object qryInOut: TIBOQuery
    ...
    OnFilterRecord = qryInOutFilterRecord
    SQL.Strings = (
      'SELECT MAHH'
      '     , TENHH'
      '     , SLDAUKY'
