object BalObjFactor1Frm: TBalObjFactor1Frm
  Tag = 25
  Left = 252
  Top = 144
  Width = 615
  ...
  object locForm: TdxLayoutControl
    ...
    object grdObj: TdxDBGrid
      ...
      object grdObjFACTOR_ID: TdxDBGridPopupColumn
        ...
        Caption_UTF7 = 'Y+Hr8-u t+HtE 1'
      end
      object grdObjFACTOR_ID_1: TdxDBGridPopupColumn
        ...
        BandIndex = 0
        RowIndex = 0
        FieldName = 'FACTOR_ID_1'
        PopupControl = PopupFrm.PnlCommonObj
        PopupFormBorderStyle = pbsSimple
        OnCloseUp = grdObjFACTOR_ID_1CloseUp
        Caption_UTF7 = 'Y+Hr8-u t+HtE 2'
      end
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Name = 'Tahoma'
        Font.Style = []
        Caption = 'S'#7889' d'#432' chi ti'#7871't ban '#273#7847'u theo y'#7871'u t'#7889' 2'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 120
  ...
  object qryBeginObj: TIBOQuery
    ...
    InsertSQL.Strings = (
      ...
      '   :BEGIN_CREDIT)')
    KeyLinks.Strings = (
      'FACTOR_BAL_1.OBJECT_ID'
      'FACTOR_BAL_1.OTYPE_ID'
      'FACTOR_BAL_1.ACCOUNT_ID'
      'FACTOR_ID'
      'FACTOR_TYPE'
      'FACTOR_ID_1'
      'FACTOR_TYPE_1'
    ...
    DataSource = MainDM.dsPAcc
    SQL.Strings = (
      'SELECT FACTOR_BAL_1.OBJECT_ID'
      '     , FACTOR_BAL_1.OTYPE_ID'
      '     , FACTOR_BAL_1.ACCOUNT_ID'
      '     , FACTOR_BAL_1.OBJECT_ID||FACTOR_ID||FACTOR_ID_1 KF'
      '     , FACTOR_ID'
      '     , FACTOR_TYPE'
      '     , FACTOR_ID_1'
      '     , FACTOR_TYPE_1'
      ...
      'FROM FACTOR_BAL_1'
        ...
        'JOIN OBJECT_LIST on (OBJECT_LIST.OBJECT_ID=FACTOR_BAL_1.OBJECT_I' +
        'D and OBJECT_LIST.OTYPE_ID= FACTOR_BAL_1.OTYPE_ID)'
      
        'where PERIOD_ID=:PERIOD_ID and BRANCH_ID =:BRANCH_ID and FACTOR_' +
        'BAL_1.ACCOUNT_ID=:ACCOUNT_ID')
    FieldOptions = []
    Left = 229
    Top = 172
    ...
    object qryBeginObjFACTOR_ID_1: TWideStringField
      FieldName = 'FACTOR_ID_1'
      Required = True
      Size = 30
    end
    object qryBeginObjFACTOR_TYPE_1: TSmallintField
      FieldName = 'FACTOR_TYPE_1'
      Required = True
    end
