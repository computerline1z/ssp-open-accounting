object AccDetailAriseFrm: TAccDetailAriseFrm
  Tag = 30
  Left = 227
  Top = 198
  Width = 638
  ...
  object qryObjArise: TIBOQuery
    ...
    OnFilterRecord = qryObjAriseFilterRecord
    DataSource = MainDM.dsPAcc
    SQL.Strings = (
      'SELECT MADT'
      '     , LOAIDT'
      ...
      '     , NOCK'
      '     , COCK'
      'FROM MACRO_DOITUONGPS(:PERIOD_ID,:PERIOD_ID,:BRANCH_ID)'
      'order by MADT')
    FieldOptions = []
    Left = 253
    Top = 220
    object qryObjAriseMADT: TWideStringField
      FieldName = 'MADT'
      Size = 30
    end
    object qryObjAriseLOAIDT: TSmallintField
      FieldName = 'LOAIDT'
    end
    object qryObjAriseTENDT: TWideStringField
      FieldName = 'TENDT'
      Size = 126
    end
