object HVSKQHDKDCondFrm: THVSKQHDKDCondFrm
  Left = 270
  Top = 162
  HelpContext = 17
  ...
  object qryLCTTCond: TIBOQuery
    ...
    DatabaseName = 'D:\My Project\Accounting\Acc TalentNet\DB\ACCOUNTINGNB1.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM RPT_KQHDKD_HVS_CON'
      'WHERE'
      '   ID = :OLD_ID AND'
      '   TKCOBDV = :OLD_TKCOBDV AND'
      '   TKNOBDV = :OLD_TKNOBDV')
    EditSQL.Strings = (
      'UPDATE RPT_KQHDKD_HVS_CON SET'
      '   ID = :ID, /*PK*/'
      '   TKCOBDV = :TKCOBDV, /*PK*/'
      '   TKNOBDV = :TKNOBDV, /*PK*/'
      '   GHICHU = :GHICHU,'
    ...
    InsertSQL.Strings = (
      'INSERT INTO RPT_KQHDKD_HVS_CON('
      '   ID, /*PK*/'
      '   TKCOBDV, /*PK*/'
      '   TKNOBDV, /*PK*/'
      '   GHICHU,'
