...
uses
  ...
  IB_Script, ComCtrls, ImgList,ppTypes, ppStrtch, ppSubRpt;
type
  TfrmReportList = class(TForm)
    ...
    lcBieuThucItem10: TdxLayoutItem;
    lcBieuThucItem2: TdxLayoutItem;
    lcBieuThucItem3: TdxLayoutItem;
    dxLayoutItem2: TdxLayoutItem;
    lcBieuThucGroup6: TdxLayoutGroup;
    lcBieuThucGroup10: TdxLayoutGroup;
    lcBieuThucGroup9: TdxLayoutGroup;
    lcBieuThucItem5: TdxLayoutItem;
    lcBieuThucItem6: TdxLayoutItem;
    lcBieuThucItem7: TdxLayoutItem;
    lcBieuThucGroup12: TdxLayoutGroup;
    lcBieuThucItem15: TdxLayoutItem;
    lcBieuThucItem16: TdxLayoutItem;
    lcBieuThucItem17: TdxLayoutItem;
    dxLayoutGroup2: TdxLayoutGroup;
    lcBieuThucItem14: TdxLayoutItem;
    lcBieuThucItem19: TdxLayoutItem;
    lcBieuThucItem18: TdxLayoutItem;
    lcBieuThucGroup11: TdxLayoutGroup;
    lcBieuThucItem13: TdxLayoutItem;
    lcBieuThucItem9: TdxLayoutItem;
    lcBieuThucItem8: TdxLayoutItem;
    lcBieuThucGroup3: TdxLayoutGroup;
    lcBieuThucGroup2: TdxLayoutGroup;
    lcBieuThucGroup4: TdxLayoutGroup;
    lcBieuThucItem21: TdxLayoutItem;
    lcnodk: TdxLayoutItem;
    lcnops: TdxLayoutItem;
    lcnock: TdxLayoutItem;
    lcBieuThucGroup5: TdxLayoutGroup;
    lccodk: TdxLayoutItem;
    lccops: TdxLayoutItem;
    lccock: TdxLayoutItem;
    ...
    lcBieuThucGroup8: TdxLayoutGroup;
    lcBieuThucGroup14: TdxLayoutGroup;
    lcBieuThucGroup15: TdxLayoutGroup;
    lcBieuThucGroup16: TdxLayoutGroup;
    dxDBSpinEdit1: TdxDBSpinEdit;
    lcDoUuTien: TdxLayoutItem;
    lcBieuThucGroup13: TdxLayoutGroup;
    lcValue: TdxLayoutItem;
    ElPopupButton4: TElPopupButton;
    lcBieuThucGroup17: TdxLayoutGroup;
    ...
    lcBieuThucItem1: TdxLayoutItem;
    lcBieuThucItem4: TdxLayoutItem;
    lcBieuThucItem12: TdxLayoutItem;
    lcBieuThucItem20: TdxLayoutItem;
    lcBieuThucItem22: TdxLayoutItem;
    lcBieuThucItem23: TdxLayoutItem;
    lcBieuThucGroup19: TdxLayoutGroup;
    lcBieuThucGroup20: TdxLayoutGroup;
    lcBieuThucGroup21: TdxLayoutGroup;
    lcBieuThucGroup22: TdxLayoutGroup;
    lcBieuThucGroup18: TdxLayoutGroup;
    lcBieuThucItem24: TdxLayoutItem;
    ElPopupButton17: TElPopupButton;
    lcBieuThucItem25: TdxLayoutItem;
    ElPopupButton18: TElPopupButton;
    lcBieuThucItem26: TdxLayoutItem;
    ElPopupButton19: TElPopupButton;
    lcBieuThucItem27: TdxLayoutItem;
    ElPopupButton20: TElPopupButton;
    lcBieuThucItem28: TdxLayoutItem;
    ElPopupButton21: TElPopupButton;
    lcBieuThucItem29: TdxLayoutItem;
  ...
  private
    ...
    function nodk(shtk:variant):variant;
    function codk(shtk:variant):variant;
    function nock(shtk:variant):variant;
    function cock(shtk:variant):variant;
    function nops(shtk:variant):variant;
    function cops(shtk:variant):variant;

    function nodkdt(shtk:variant):variant;
    function codkdt(shtk:variant):variant;
    function nockdt(shtk:variant):variant;
    function cockdt(shtk:variant):variant;
    function nopsdt(shtk:variant):variant;
    function copsdt(shtk:variant):variant;
    function nodkyt(shtk:variant):variant;
    function codkyt(shtk:variant):variant;
    function nockyt(shtk:variant):variant;
    function cockyt(shtk:variant):variant;
    function nopsyt(shtk:variant):variant;
    function copsyt(shtk:variant):variant;
...
begin
  ...
  begin
    ...
    qryTemp35.SQL.Text := 'select object_id,object_name from object_list where object_list.otype_id = ' + qryCols.FieldByName('REPORT_OBJECT_TYPE').AsString;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            temp := cal3(qryTable,qryTemp35.FieldByName('OBJECT_ID').AsString);

            sum := sum + temp;

            object_id := AnsiReplaceStr(qryTemp35.FieldByName('OBJECT_ID').AsString,'.','_');
            ...
            Mem.FieldByName(object_id+'NAME').Value := qryTemp35.fieldbyname('OBJECT_NAME').Value;
            ...
            Mem.FieldByName('TONGCONG').Value := 0;
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          qryTemp35.SQL.Text := ' select object_id,object_name from object_list where object_list.otype_id = ' + qryTable.FieldByName('REPORT_OBJECT_TYPE_COL').AsString;
          qryTemp35.Prepare;
          ...
          begin
            ...
            Mem.FieldByName(object_id).Value := temp;
            Mem.FieldByName(object_id + 'TYPE').Value :=
               qryTable.FieldByName('REPORT_ISEXPRESSION').value;
            Mem.FieldByName(object_id + 'FORMAT').Value :=
               qryTable.FieldByName('REPORT_COL_BOLD').value + qryTable.FieldByName('REPORT_ITEM_BOLD').value*10;

            Mem.FieldByName(object_id+'NAME').Value := qryTemp35.fieldbyname('OBJECT_NAME').Value;
            Mem.FieldByName(object_id + 'NAMETYPE').Value :=
               qryTable.FieldByName('REPORT_ISEXPRESSION').value;
            Mem.FieldByName(object_id + 'NAMEFORMAT').Value :=
               qryTable.FieldByName('REPORT_COL_BOLD').value + qryTable.FieldByName('REPORT_ITEM_BOLD').value*10;
          ...
          Mem.FieldByName('TONGCONGNAME').Value := UTF8Decode('Tổng cộng');
          Mem.FieldByName('TONGCONGNAMEFORMAT').Value :=
               qryTable.FieldByName('REPORT_COL_BOLD').value + qryTable.FieldByName('REPORT_ITEM_BOLD').value*10;
          Mem.FieldByName('TONGCONG').Value := sum;
          Mem.FieldByName('TONGCONGTYPE').Value :=
               qryTable.FieldByName('REPORT_ISEXPRESSION').value;
          Mem.FieldByName('TONGCONGFORMAT').Value :=
               qryTable.FieldByName('REPORT_COL_BOLD').value + qryTable.FieldByName('REPORT_ITEM_BOLD').value*10;
        end;
      end
      else
...
function TfrmReportList.CoCK(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select cock from macro_sodutk(' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('cock').Value;
    qrytemp.Close;
  end;
end;

function TfrmReportList.CoDK(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select codk from macro_sodutk(' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('codk').Value;
    qrytemp.Close;
  end;
end;

function TfrmReportList.CoPS(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    ...
    qryTemp.Open;
    Result := qrytemp.FieldByName('cops').Value;
    qrytemp.Close;
  end;
end;

function TfrmReportList.NoCK(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select nock from macro_sodutk(' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
...
function TfrmReportList.NoDK(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select nodk from macro_sodutk(' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('nodk').Value;
    qrytemp.Close;
  end;
end;

function TfrmReportList.NoPS(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    ...
    qryTemp.Open;
    Result := qrytemp.FieldByName('nops').Value;
    qrytemp.Close;
  end;
end;
...
begin
  ...
  begin
    ...
    AddMethod1Param('nodk',nodk);
    AddMethod1Param('codk',codk);
    AddMethod1Param('nock',nock);
    AddMethod1Param('cock',cock);
    AddMethod1Param('nops',nops);
    AddMethod1Param('cops',cops);

    AddMethod1Param('nodkdt',nodkdt);
    AddMethod1Param('codkdt',codkdt);
    AddMethod1Param('nockdt',nockdt);
    AddMethod1Param('cockdt',cockdt);
    AddMethod1Param('nopsdt',nopsdt);
    AddMethod1Param('copsdt',copsdt);

    AddMethod1Param('nodkyt',nodkyt);
    AddMethod1Param('codkyt',codkyt);
    AddMethod1Param('nockyt',nockyt);
    AddMethod1Param('cockyt',cockyt);
    AddMethod1Param('nopsyt',nopsyt);
    AddMethod1Param('copsyt',copsyt);
...
begin
  ...
  begin
    ...
    begin
      ...
      result := CheckOtherCondition(qryTemp.Fields[0].Value, qryTable.FieldByName('REPORT_OTHER_CONDITION').AsInteger);
  ...
  3:
  begin
    qryTemp.SQL.Text := 'select valuex from MACRO_CAL_F_REPORT(:REPORT_ID,:REPORT_COL_ID,:REPORT_ITEM_ID,:TUKY,:DENKY)';
    qryTemp.Prepare;
...
begin
  ...
  begin
    ...
    ftfloat:
    begin
      if frommem.Fields[i].FieldName = 'TONGCONG' then
        ok := true
      else
      begin
        ok := false;
      ...
      begin
        ...
        Field.SetFieldType(ftfloat);
        Field.FieldKind := fkData;
        Field.FieldName := FromMem.Fields[i].FieldName;
        Field.DataSet := temp;
        TFloatField(Field).DisplayFormat := TIENTE_FORMAT;
        ...
        Field.FieldKind := fkData;
        Field.FieldName := FromMem.Fields[i].FieldName + 'TYPE';
        Field.DataSet := temp;

        Field := TIntegerField.Create(temp);
        Field.SetFieldType(ftInteger);
        Field.FieldKind := fkData;
        Field.FieldName := FromMem.Fields[i].FieldName + 'FORMAT';
        Field.DataSet := temp;
      end
    end;
    ftWideString:
    begin
      ...
      if (FromMem.Fields[i].FieldName <> 'REPORT_ITEM_NAME_ID') and (FromMem.Fields[i].FieldName <> 'REPORT_IMAGETYPE') then
      begin
        Field := TIntegerField.Create(temp);
        Field.SetFieldType(ftInteger);
        Field.FieldKind := fkData;
    ...
    ftInteger:
    begin
      if FromMem.Fields[i].FieldName = 'REPORT_ITEM_ID' then
      begin
        Field := TIntegerField.Create(temp);
        Field.SetFieldType(ftInteger);
  ...
  begin
    ...
    begin
      temp.Fields[i].Value := frommem.fieldbyname(temp.Fields[i].FieldName).Value;

      if temp.Fields[i].DataType = ftfloat then
        sum := sum + frommem.fieldbyname(temp.Fields[i].FieldName).Value;
    end;
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            if FieldReport.DataType = ftFloat then
            begin
...
function TfrmReportList.cockdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select cock from macro_sodudt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('cock').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.codkdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select codk from macro_sodudt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('codk').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.copsdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
...
function TfrmReportList.nockdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
...
function TfrmReportList.nodkdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select nodk from macro_sodudt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('nodk').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.nopsdt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select nops from macro_sodudt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('nops').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.cockyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select cock from macro_soduyt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('cock').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.codkyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select codk from macro_soduyt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('codk').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.copsyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
...
function TfrmReportList.nockyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
...
function TfrmReportList.nodkyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
  begin
    qryTemp.SQL.Text := 'select nodk from macro_soduyt(''' +object_id + ''',' + string(shtk) + ',' + inttostr(FromPeriod) + ',' + inttostr(ToPeriod) + ')';
    qryTemp.Open;
    Result := qrytemp.FieldByName('nodk').Value;
    qrytemp.Close;
  end;
...
function TfrmReportList.nopsyt(shtk: variant): variant;
begin
  if TestFlag then
    Result := 1
  else
      ...
      begin
        ...
        begin
          ...
          begin
            ...
            qryUpdate.ParamByName('REPORT_ITEM_ID').Value := qrySubTables.FieldByName('REPORT_ITEM_ID').Value;
            qryUpdate.ParamByName('REPORT_COL_ID').Value := qrySubTables.FieldByName('REPORT_COL_ID').Value;
            qryUpdate.ParamByName('VALUEX').Value := CheckOtherCondition(qryTemp.Fields[0].Value, qrySubTables.FieldByName('REPORT_OTHER_CONDITION').AsInteger);
            qryUpdate.ExecSQL;
            qryUpdate.IB_Transaction.CommitRetaining;
