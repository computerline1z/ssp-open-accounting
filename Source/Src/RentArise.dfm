object RentAriseFrm: TRentAriseFrm
  Tag = 30
  Left = 237
  Top = 192
  Width = 638
  ...
  object locForm: TdxLayoutControl
    ...
    object grdHH: TdxDBGrid
      ...
      object grdHHMACT: TdxDBGridMaskColumn
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = 'T'#236'nh cho thu'#234' h'#224'ng trong th'#225'ng'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 136
  ...
  object qryRentArise: TIBOQuery
    ...
    SQL.Strings = (
      'SELECT MACT,MAKH,MAHH,TENHH,DVT,SHTK'
      '     , MACT||MAKH||MAHH||SHTK KF'
      '     , SLDAUKY,GTDAUKY'
      '     , SLTHUE,GTTHUE'
      '     , SLTRA,GTTRA,GTHAOMON'
      '     , SLTON,GTTON'
      '     , WORK_NAME'
      'FROM MACRO_CHOTHUEPS(:PERIOD_ID,:PERIOD_ID)'
      'JOIN WORK_LIST on (MACT=WORK_LIST.WORK_ID)'
      'order by MAKH,MACT,MAHH,SHTK')
    FieldOptions = []
    Left = 237
    Top = 220
    ...
    object qryRentAriseWORK_NAME: TWideStringField
      FieldName = 'WORK_NAME'
      Size = 126
    end
