object TMBCTC_THDTFrm: TTMBCTC_THDTFrm
  Left = 238
  Top = 140
  Width = 716
  Height = 509
  ...
  object dxDBGridLayoutList1: TdxDBGridLayoutList
    ...
    object dxDBGridLayoutList1Item1: TdxDBGridLayout
      Data = {
        ...
        2C200A44617461536F7572636507174465665270745454445446726D2E647350
  ...
  object qryTTDT: TIBOQuery
    ...
    DatabaseName = 'F:\Tai chinh Ke toan\Baohime\Ketoan\DB\Db.gdb'
    DeleteSQL.Strings = (
      'DELETE FROM RPT_TINHHINH_DAUTU'
      'WHERE'
      '   ID = :OLD_ID')
    EditSQL.Strings = (
      'UPDATE RPT_TINHHINH_DAUTU SET'
      '   ID = :ID, /*PK*/'
      '   MANHOM = :MANHOM,'
      '   TEN = :TEN,'
      '   MASO = :MASO,'
    ...
    IB_Connection = MainDM.cnMain
    InsertSQL.Strings = (
      'INSERT INTO RPT_TINHHINH_DAUTU('
      '   ID, /*PK*/'
      '   MANHOM,'
      '   TEN,'
      '   MASO,'
