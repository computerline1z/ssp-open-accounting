object ThongkeHMFrm: TThongkeHMFrm
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = 'B'#7843'ng th'#7889'ng kê tình hình s'#7917' d'#7909'ng h'#7841'n m'#7913'c, ngân sách'
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 256
  ...
  object qryHMPhatsinh: TIBOQuery
    ...
    SQL.Strings = (
        ...
        'select maso,tenhm, giatri from sp_tk_hanmuc(:tungay,:denngay,:br' +
        'anch_id)')
    FieldOptions = []
    Left = 217
    Top = 148
