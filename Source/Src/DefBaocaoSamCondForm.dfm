object DefBaocaoSamCondFrm: TDefBaocaoSamCondFrm
  Left = 297
  Top = 205
  HelpContext = 17
  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = #272'i'#7873'u ki'#7879'n B'#225'o c'#225'o '
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 136
  ...
  object qryLCTTCond: TIBOQuery
    ...
    DatabaseName = 'D:\My Project\Accounting\Acc Samudera\db\accounting.GDB'
    DeleteSQL.Strings = (
      'DELETE FROM SAM_RPT_BAOCAO_CONDITION'
      'WHERE'
      '   ID = :OLD_ID AND'
      '   TKCOBDV = :OLD_TKCOBDV AND'
      '   TKNOBDV = :OLD_TKNOBDV')
    EditSQL.Strings = (
      'UPDATE SAM_RPT_BAOCAO_CONDITION SET'
      '   ID = :ID, /*PK*/'
      '   TKCOBDV = :TKCOBDV, /*PK*/'
      '   TKNOBDV = :TKNOBDV, /*PK*/'
      '   GHICHU = :GHICHU,'
    ...
    InsertSQL.Strings = (
      'INSERT INTO SAM_RPT_BAOCAO_CONDITION('
      '   ID, /*PK*/'
      '   TKCOBDV, /*PK*/'
      '   TKNOBDV, /*PK*/'
      '   GHICHU,'
    ...
    SQL.Strings = (
      ...
      '     , GHICHU'
      '     , HESO'
      'FROM SAM_RPT_BAOCAO_CONDITION where ID=:ID')
    FieldOptions = []
    Left = 163
    Top = 64
