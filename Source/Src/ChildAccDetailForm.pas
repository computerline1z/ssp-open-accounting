...
type
  TChildAccDetailFrm = class(TForm)
...
var
  ChildAccDetailFrm: TChildAccDetailFrm;
...
procedure TChildAccDetailFrm.FormCreate(Sender: TObject);
begin
  locForm.BeginUpdate;
...
procedure TChildAccDetailFrm.dxBarButton1Click(Sender: TObject);
begin
  ExportToExcel(grdKH);
end;

procedure TChildAccDetailFrm.dxBarButton2Click(Sender: TObject);
begin
  ExportToHTML(grdKH);
end;

procedure TChildAccDetailFrm.dxBarButton3Click(Sender: TObject);
begin
  ExportToXML(grdKH);
end;

procedure TChildAccDetailFrm.btnDetailClick(Sender: TObject);
...
begin
  ...
  begin
    ...
    sqlSel :=sqlSelectDocList + ' where TKNO = :ASHTK  or TKCO= :ASHTK';
...
procedure TChildAccDetailFrm.grdKHDblClick(Sender: TObject);
begin
  btnDetailClick(Sender);
end;

procedure TChildAccDetailFrm.grdKHKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TChildAccDetailFrm.dxBarButton4Click(Sender: TObject);
begin
  qryObjArise.Refresh;
end;

procedure TChildAccDetailFrm.bbtnFilterClick(Sender: TObject);
begin
  grdKH.Filter.Active := bbtnFilter.Down;
end;

procedure TChildAccDetailFrm.grdKHEnter(Sender: TObject);
begin
  if qryObjArise.Active=False then
    qryObjArise.Open;
end;

procedure TChildAccDetailFrm.grdKHMouseDown(Sender: TObject;
...
procedure TChildAccDetailFrm.grdKHMouseUp(Sender: TObject;
  Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
...
procedure TChildAccDetailFrm.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key=VK_F1 then
...
procedure TChildAccDetailFrm.FormShow(Sender: TObject);
begin
  SetVisible(Self);
end;
