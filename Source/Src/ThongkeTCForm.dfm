  ...
  object ElFormCaption1: TElFormCaption
    ...
    Texts = <
      item
        ...
        Font.Style = []
        Caption = 'Th'#7889'ng kê tình hình thu chi t'#7891'n qu'#7929
        Layout = blGlyphLeft
        Align = taLeftJustify
      end>
    Left = 360
